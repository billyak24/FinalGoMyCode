...
const data = [
  {
    ...
    title: "Be Safe+",
    desc:
      "With be Safe+ we have brought in a set of measures like Sanitized buses, mandatory masks etc. to ensure you travel safely."
  },
  {
    img: "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.etechgs.com%2Fblog%2Flive-chat-superior-customer-service%2F&psig=AOvVaw2_hSezmklHmtgmtLKab_oI&ust=1676161447060000&source=images&cd=vfe&ved=0CBAQjRxqFwoTCLCFjpSajP0CFQAAAAAdAAAAABAD",
