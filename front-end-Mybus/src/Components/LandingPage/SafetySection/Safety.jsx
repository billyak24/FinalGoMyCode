...
const arr = [
  {
    ...
    descriptions:
      "All Be safe+ buses are sanitized and disinfected before and after every trip."
  },
  {
  ...
  return (
    <div className={styles.mainContainer}>
      ...
      <div className={styles.writingConatiner}>
        <h2>Introducing Be Safe+</h2>
        <h3>Opt to Travel Safe with MyBus</h3>
        <span
        ...
        <p>
          Look for buses with &nbsp;{" "}
          <span className={styles.boldspan}> Be Safe+</span> &nbsp; tag while
          booking your journey in myBus
        </p>
