        ...
        <div>
            <div className={Styles.pricingBushire}>
                ...
                <div className={Styles.pricing_paraSection}>
                    By booking your vehicle via MyBus, you knock out middlemen charges, and charges associated with bookings made in advance. MyBus also provides packages for tourists in cities where the service is available.Charges for vehicles depend on the city in which they are hired. Starting base prices are mentioned below:
                </div>
