      ...
      <div className={Styles.baneer}>
        <div>
          <img
            ...
            src="https://images.unsplash.com/photo-1509749837427-ac94a2553d0e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80"
            alt="banner"
            width="100%"
          />
        ...
        <div className={Styles.whyBookWithBushire}>
          ...
          <div>
            <img
              ...
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Situation_R%C3%A9seau_Autoroutier_Alg%C3%A9rier_-_Mai_2015_-_V.03.png/2880px-Situation_R%C3%A9seau_Autoroutier_Alg%C3%A9rier_-_Mai_2015_-_V.03.png"
              alt=""
            />
          </div>
        </div>
        ...
        {/* hire us Whenever */}
        <div className={Styles.VehicleYouCanGet}>
          <div className={Styles.bookInEasySteps_heading}>Hire us when ever you want</div>
          ...
          <div className={Styles.hireuswhenever_paraSection}>
            ...
            just a few hours, we will meet your needs. MyBus for hire is now one
            click away. We also ensure extra comfort, luxurious and hassle-free
            experience, and of course, a punctual and expert service
          </div>
        </div>
        {/* hire and renting a bus with Mybus */}
        <div className={Styles.VehicleYouCanGet}>
          <div className={Styles.bookInEasySteps_heading}>
            Hiring/Renting A Bus with MyBus
          </div>
          <div className={Styles.hireuswhenever_paraSection}>
            MyBus understands that comfort and enjoyment are important while
            travelling. Therefore, we have collaborated with some of the finest
            travel agencies in Algeria to render a perfect trip to our customers.
          ...
          <div className={Styles.hireuswhenever_paraSection}>
            ...
            Sleeper bus booking is possible online with MyBus Bus Hire.
          </div>
        </div>
        {/*booking online buses */}
        <div className={Styles.VehicleYouCanGet}>
          <div className={Styles.bookInEasySteps_heading}>
            Booking Buses Online with MyBus
          </div>
          <div className={Styles.hireuswhenever_paraSection}>
            MyBus has identified the public’s love of travel and has made the
            renting/hiring of buses and tempo travellers easy. We hold almost
            30,000 buses, covering almost 50,000 routes throughout Algeria
          ...
          <div className={Styles.hireuswhenever_paraSection}>
            ...
            or by downloading our app on your mobile phones (App store . Play store).
          </div>
          <div className={Styles.hireuswhenever_paraSection}>
        ...
        <div className={Styles.VehicleYouCanGet}>
          <div className={Styles.bookInEasySteps_heading}>
            Things to know about MyBus Hire
          </div>
          <div className={Styles.hireuswhenever_paraSection}>
            MyBus is amongst the list of renowned online bus booking websites.
            ...
            experienced drivers drive buses. MyBus makes booking an ordinary
          ...
          <div className={Styles.hireuswhenever_paraSection}>
            MyBus has been making sure to take care of all its customer’s
            health and also play a role in curbing the further spread of
            COVID-19. In a bid to do just this, MyBus has come out with an
