        ...
        <div>
            <div className={Styles.faqDivContainer}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                    ...
                    {arrow1 === "upArrow" &&
                        <div className={Styles.faqsEachAnswerDiv}>MyBus Hire helps you rent a vehicle from the best operators in your city.</div>}
                    <div className={Styles.faqsEachDiv}>
                        <div className={Styles.faqDivText}>
                            How does it work?
                            </div>
                    ...
                    {arrow3 === "upArrow" &&
                        <div className={Styles.faqsEachAnswerDiv}>We are currently operational in Oran Costantine BAOUMERDASE Setif .</div>}
                    <div className={Styles.faqsEachDiv}>
                        <div className={Styles.faqDivText}>
                    ...
                    {arrow10 === "upArrow" &&
                        <div className={Styles.faqsEachAnswerDiv}>MyBus, in light of the recent rapid spread of COVID-19, has introduced a new move which they call Safety+. Under Safety+, all buses are required to adhere to certain strict rules and guidelines. Some of these include regular and strict temperature checks along with advisories, making the use of masks mandatory for all employees as well as passengers, and sanitisers must be provided before boarding and present on all buses at all times.</div>
                    }
                    <div className={Styles.faqsEachDiv}>
                        <div className={Styles.faqDivText}>
                            How long is MyBus Bus Hire customer care available?
                            </div>
                    ...
                    {arrow11 === "upArrow" &&
                        <div className={Styles.faqsEachAnswerDiv}>Mybus customer care is available at all hours, that is, 24/7. The customer care staff are friendly and can be asked about any redBus bus hire questions without hesitation.</div>
                    }
                    <div className={Styles.faqsEachDiv}>
                        <div className={Styles.faqDivText}>
                            Will there be blankets and linens provided in a complementary fashion aboard the Vehicle with MyBus?
                            </div>
                    ...
                    {arrow12 === "upArrow" &&
                        <div className={Styles.faqsEachAnswerDiv}>For the time being, due to the current situation created by the pandemic, MyBus will not be allowing the provision of blankets and various other cover-ups. This measure falls under the Safety+ guidelines.</div>
                    }
