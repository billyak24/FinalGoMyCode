    ...
    <div className={styles.detailsContainer}>
      <div className={styles.detailsLeftContainer}>
        ...
        <div>
          ...
          <p className={styles.para1}>
            ...
            <span style={{ color: "black", fontWeight: "700" }}>700 </span>km
          </p>
        </div>
        <div>
          ...
          <div>
            ...
            <ul className={styles.busStyleList}>
              <li>
                Trip cost is calculated on a minimum distance of 700 KM. Any
                usage beyond this will be billed at DA. 17/KM
              </li>
              <li>
              ...
              <li>
                ...
                provided for lesser than the 700 KM or the trip time indicated
              </li>
              <li>
                Interstate taxes of DA. 200 is already included in your trip.
              </li>
              <li>
                Night  charges of  250 DA/Night are applicable in case
          ...
          <div>
            ...
            <ul className={styles.busStyleList}>
              <li>Free Cancellation till 19 fev 2023, 04:15 AM</li>
      ...
      <div className={styles.detailsRightContainer}>
        ...
        <div>
          ...
          >
            <p className={styles.redBoxkm}>700 kms</p>
            <p className={styles.redBoxkm}>DA.{currentBus.total}</p>
            <span
              style={{
                display: "inline",
                fontSize: "14px",
            ...
            >
              Extra km: 100DA/km | Extra hour: 200DA
            </span>
          </div>
          <div>
            <h4
          ...
          <div>
            ...
            <div className={styles.breakingPrices}>
              <li>
                ...
                <p className={styles.greyp}>12000 DA</p>
              </li>
              <li>
                <p className={styles.greyp}>Driver Allowance</p>
                <p className={styles.greyp}>500 DA</p>
              </li>
              <li>
                <p className={styles.greyp}>GET @ 5%</p>
                <p className={styles.greyp}>2000 DA</p>
              </li>
              <li>
                <p className={styles.greyp}>Interstate taxes</p>
                <p className={styles.greyp}>900 DA</p>
              </li>
              <li>
                <p className={styles.greyp}>Interstate taxes</p>
                <p className={styles.greyp}>980 da</p>
              </li>
              <li
                style={{
